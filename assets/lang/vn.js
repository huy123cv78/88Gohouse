const vn = {
  ...
  register: {
    ...
    phonePlaceholder: 'Vui lòng nhập số điện thoại',
    pwd: 'Mật khẩu',
    pwdplaceholder: 'Vui lòng nhập mật khẩu từ 8 đến 12 ký tự bao gồm các ký tự chữ và số (không bao gồm chữ in hoa)',
  ...
  memberCenter: {
    ...
    field: 'Cánh đồng',
    friends: 'Được bạn bè giới thiệu',
    inviteFriendsLink: 'Liên kết',
    totalRewardsThisMonth: 'Tổng phần thưởng tháng này',
    personalPublishingRewards: 'Phần thưởng xuất bản cá nhân',
    firstLevelRewards: 'Phần thưởng cấp một',
    secondLevelRewards: 'Thưởng cấp hai',
    thirdLevelRewards: 'Thưởng cấp ba',
    bonusStatistics: 'Thống kê thưởng',
    numberOfPersonalListings: 'Số lượng danh sách cá nhân',
    numberOfFriendsPublishing: 'Số bài viết được đăng bởi bạn bè',
    numberOfPeoplePublishedByFriends: 'Được đăng bởi bạn bè',
    numberOfPublishingOnTheSecondLevel: 'Số lượng danh sách cấp hai',
    numberOfPeoplePublishingOnTheSecondLevel: 'Số người đăng ở cấp độ thứ hai',
    numberOfPublishingOnTheThirdLevel: 'Số lượng danh sách cấp ba',
    numberOfPeoplePublishingOnTheThirdLevel: 'Cấp độ thứ ba của nhà xuất bản',
    memberName: 'Tên thành viên',
    memberNamePlaceholder: 'Vui lòng nhập tên thành viên',
    friendsInfo: 'Thông tin bạn bè',
    numberOfPeopleInTheDownLine: 'Số lượng nhân viên cấp dưới',
    numberOfPeoplePublishedInTheDownLine: 'Số lượng nhân viên cấp dưới đã đăng',
    totalNumberOfListingsBySubordinates: 'Tổng số lượng bài đăng của nhân viên cấp dưới',
    friendsRule: '好友推荐规章',
  },
  forumPage: {
    enTitle: 'Forum',
  ...
  dialog: {
    ...
    promotionDetail: 'Chi tiết ngoại tuyến của nhà quảng bá',
    downlineName: 'Tên tuyến dưới của nhà quảng bá',
