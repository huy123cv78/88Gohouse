const zhCn = {
  ...
  login: {
    ...
    pwd: '密码',
    pwdplaceholder: '请输入密码8至12位包含英数字',
    remember: '记住我',
    forget: '忘记密码',
    login: '登录',
    noAccount: '还没有账号吗？',
  ...
  friendRules: {
    ...
    slogan1: '好友推荐，共享刊登奖励！',
    subSlogan: '邀请他人加入，一同享受刊登奖励',
    description1: '88go为了让每位会员都能享受更多回报，特别推出了我们独特的会员好友推荐方案。当你成功邀请他人加入会员，你将在对方刊登时获得奖励。而更值得期待的是，你可以获得不仅限于你的好友，也包括你引荐的会员和他们所引荐的会员的刊登奖励。',
    process: '好友推荐的流程',
    join: '加入前',
    joinDescription2: '再加入88go前，您可以通过填写他人的代码，成为对方代理的一员。加入我们的会员后，您也获得能成为代理的机会。',
    becomeMember: '成为会员',
    ...
    becomeAgentDescription: '成功邀請他人加入後，即擁有代理的身份，透過代理方案，您將擁有佣金收入，並且您所邀請的對象的交易利潤也能進行分成。',
    bonus: '如何计算奖金',
    rewardCalculationRules: '奖励计算规则',
    algorithm: '各层级刊登件数×单件奖励×各层级刊登总人数',
    listPara1: '会员个人单件刊登奖励10,000点。',
    level1: '第一层好友刊登奖励',
    level2: '第二层好友刊登奖励',
    level3: '第三层好友刊登奖励',
    listPara2: '第一层好友单件刊登奖励会员1,000点，刊登人数最高上限5人，刊登件数无上限。',
    listPara3: '第二层好友单件刊登奖励会员500点，刊登人数最高上限5人，刊登件数无上限。',
    listPara4: '第三层好友单件刊登奖励会员250点，刊登人数最高上限5人，刊登件数无上限。',
    forExample: '以上图举例：',
    invite: '邀请多人',
    inviteDescription: '连锁效应让你的影响力和收益不断扩大，邀请越多人，获得的佣金也越多。',
    accounting: '金额透明',
    accountingDescription: '每月月底的奖励统计将自动派发，会员也能即时查看奖励，确保奖励的派发计算即时、透明。',
    profits: '隔代奖励',
    profitsDescription: '即使是你引荐的会员引荐的会员，你也能获得相应的刊登奖励。',
    joinHands: '携手分享居住的荣耀！',
    joinHandsDescription: '这种连锁效应，让你的影响力和收益将持续扩大，成为一个居住共赢的社群中的重要一环。 88go相信，这种互惠互利的模式能够为每个会员带来更多价值，并让我们一同开创更美好的租购未来。',
    join88go: '加入88go的行列',
    me: '我',
  ...
  memberCenter: {
    ...
    newPwd: '新密码',
    newPwdPlaceholder: '请输入新密码8-12位包含英数字',
    confirmNewPwd: '确认新密码',
    ...
    reportContactInfo: '联系回报',
    numberOfBuyersAndSellersToBeReported: '待回报买卖方屋主数',
    numberOfBuyersAndSellersOfClientToBeReported: '待回报买卖方客户数',
    numberOfRentalHouseOwnersToBeReported: '待回报买卖方客户数',
    numberOfRentalCustomerToBeReported: '待回报租赁方客户数',
    contactTime: '联系时间',
    contactTimePlaceholder: '请输入联系时间',
    contactInfo: '联系资讯',
    reportTime: '回报时间',
    performanceAmount: '业绩金额',
    signAndServiceFee: '(签约金额/服务费)',
    mainSalesperson: '主要业务',
    signingAmountPlaceholder: '请输入签约金额',
    monthlyActivity: '月活动量',
    missionHistory: '任务历程',
    targetTotal: '本月目标总业绩',
    totalTransaction: '本月成交总业绩',
    targetTotalOfMonth: '本月达成总业绩',
    performance: '业绩',
    ...
    buyerAndSellerOfHomeowners: '买卖屋主未审核',
    buyerAndSellerOfClient: '买卖客户未审核',
    leasingHomeowners: '租赁屋主未审核',
    leasingClient: '租赁客户未审核',
    salespersonReportInfo: '业务回报资讯',
    contactDetails: '联系详情',
    contactRecord: '电联记录',
    ...
    assistedSalesperson: '协办业务',
    chooseSalesperson: '请选择业务',
    categoryOfHousingDemands: '需求房屋类型',
    categoryOfOfficeDemands: '需求办公类型',
    categoryOfShopDemands: '需求店铺类型',
    typeOfHousingDemands: '需求房屋型态',
    typeOfFactoryDemands: '需求厂房型态',
    typeOfLandDemands: '需求土地型态',
    typeOfOfficeDemands: '需求办公型态',
    typeOfShopDemands: '需求店铺型态',
    areaDemand: '需求面积',
    layoutDemand: '需求格局',
    performanceAudit: '审核',
    contractAudit: '签约审核',
    ...
    field: '栏位',
    friends: '好友推荐',
    inviteFriendsLink: '好友邀请连结',
    totalRewardsThisMonth: '本月总奖励',
    personalPublishingRewards: '个人刊登奖励',
    firstLevelRewards: '第一层奖励',
    secondLevelRewards: '第二层奖励',
    thirdLevelRewards: '第三层奖励',
    bonusStatistics: '本月奖金统计',
    numberOfPersonalListings: '个人刊登数',
    numberOfFriendsPublishing: '好友刊登数',
    numberOfPeoplePublishedByFriends: '好友刊登人数',
    numberOfPublishingOnTheSecondLevel: '第二层刊登数',
    numberOfPeoplePublishingOnTheSecondLevel: '第二层刊登人数',
    numberOfPublishingOnTheThirdLevel: '第三层刊登数',
    numberOfPeoplePublishingOnTheThirdLevel: '第三层刊登人数',
    memberName: '会员姓名',
    memberNamePlaceholder: '请输入会员姓名',
    friendsInfo: '好友资讯',
    numberOfPeopleInTheDownLine: '下线人数',
    numberOfPeoplePublishedInTheDownLine: '下线刊登人数',
    totalNumberOfListingsBySubordinates: '下线刊登总数',
    friendsRule: '好友推荐规章',
  },
  forumPage: {
    enTitle: 'Forum',
